...
function getEmployeeInfo(employeeName) {
  const employeeArray = ["Иван", "Елена", "Максим", "Владислав", "Андрей"];
  const paymentArray = [50000, 56000, 68000, 45000, 70000];
  const index = employeeArray.indexOf(employeeName); // находим индекс сотрудника в массиве имен сотрудников
  if (index !== -1) {
